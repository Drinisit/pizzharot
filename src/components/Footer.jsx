...
const Footer = () => {
  return (
    <div className='w-full px-6 md:py-16 py-8'>
        <div className='max-w-[1240px] mx-auto text-white grid md:grid-cols-4 grid-cols-1 md:gap-6 gap-2'>
            <div className='pt-4'>
                <img className='md:h-6 h-5' src={Logo} alt="" />
                <p className='pt-2 text-base'>This page is for practice only. I dont own this images. All image are credit to the rightful owners.</p>
            </div>

            <div>
                <h1 className='font-semibold uppercase pt-3 md:text-xl text-base'>Support</h1>
            ...
            <div>
                <h1 className='font-semibold uppercase pt-3 md:text-xl text-base'>Phone</h1>
                <div className='flex flex-row pt-2'>
                <FaPhoneAlt className='mt-1' />
                <p>+636969-696-69696</p>
                </div>
                
                <h1 className='font-semibold uppercase pt-3 md:text-xl text-base'>EMAIL</h1>
                <div className='flex flex-row pt-1 md:text-lg text-base'>
                <MdEmail className='md:mt-2 mt-1' />
                <p>pizzharot@gmail.com</p>
                </div>
            </div>

            <div>
                <h1 className='font-semibold uppercase pt-3 md:text-xl text-base'>Address</h1>
                <div className='flex flex-row pt-2 md:text-lg text-base'>
                <MdLocationOn className='mt-1' />
                <p>West Philippine Sea</p>
                </div>
                
                <h1 className='font-semibold uppercase pt-3 md:text-xl text-base'>Follow Us</h1>
            ...
            <div className='text-center md:pt-8 pt-4 md:col-span-4 md:text-base text-sm'>
